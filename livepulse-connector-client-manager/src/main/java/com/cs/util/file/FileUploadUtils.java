package com.cs.util.file;


import com.cs.exception.file.FileNameLengthLimitExceededException;
import com.cs.exception.file.FileSizeLimitExceededException;
import com.cs.exception.file.InvalidExtensionException;
import com.cs.util.DateUtils;
import com.cs.util.IdUtils;
import com.cs.util.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = "/data/connectorX/uploadPath";
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException
    {
        ...
        String currentDir = StringUtils.substring(uploadDir, 1);
