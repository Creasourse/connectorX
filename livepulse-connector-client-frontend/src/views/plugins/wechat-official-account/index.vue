...
import TagSync from "./components/TagSync.vue";
...
const tabs = [
  ...
  { key: "apiSync", label: "API同步", component: markRaw(ApiSync) },
  {
    key: "eventSubscription",
    label: "事件订阅",
    component: markRaw(EventSubscription)
  },
  { key: "tagSync", label: "标签同步", component: markRaw(TagSync) },
  { key: "messagePush", label: "消息推送", component: markRaw(MessagePush) },
  { key: "eventLog", label: "事件日志", component: markRaw(EventLog) }
];
