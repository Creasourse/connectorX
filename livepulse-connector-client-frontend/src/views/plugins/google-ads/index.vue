...
import AudienceListManage from "./components/AudienceListManage.vue";
...
const tabs = [
  ...
  { key: "audience", label: "受众列表管理", component: markRaw(AudienceListManage) },
